            ...
            {step === 1 && (
              <div className="max-h-[65vh] overflow-y-auto">
                ...
                <div className="flex justify-between mt-4">
                  <button
                    onClick={() => setEditModalOpen(false)}
                    className="px-6 py-2 bg-teal-500 font-semibold text-white rounded-lg hover:bg-teal-700 transition-colors cursor-pointer"
                  >
                    Cancel
                  </button>
                  <button
                    onClick={() => setStep(2)}
                    className="px-6 py-2 bg-teal-600 text-white font-semibold rounded-lg hover:bg-teal-700 transition-colors cursor-pointer"
                  >
                    Next
                  </button>
                </div>
