        ...
        <form className="space-y-4">
          ...
          <div className="flex justify-end space-x-3 pt-4">
            ...
            <button
              type="button"
              onClick={saveFeedback}
              className="px-4 py-2 bg-teal-500 border border-transparent rounded-md text-sm font-medium text-white hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-blue-500 cursor-pointer"
            >
              Submit Feedback
            </button>
          </div>
    ...
    <div className="bg-white rounded-lg shadow p-4">
      ...
      {loading ? (
        ...
        <div className="relative max-w-7xl min-h-[67dvh] bg-white p-6 rounded-lg shadow-md z-10 content-scrollbar mb-3">
          <div className="absolute inset-0 px-2 overflow-y-auto">
            <table className="min-w-full bg-white">
              <thead className=" bg-gradient-to-r from-teal-400 to-teal-400 h-8 w-full text-white rounded-lg text-base p-6 sticky top-0">
                <tr>
                  <th
                    className="px-10 py-3 text-left text-mb font-medium text-white uppercase tracking-wider cursor-pointer"
                    onClick={() => handleSort("name")}
                  ...
                  <React.Fragment key={employee.id}>
                    <tr>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <button
                          onClick={() => handleAddFeedback(employee)}
                          className="bg-gradient-to-r from-teal-200 to-teal-200 bg-indigo-100 hover:bg-indigo-200 px-3 py-2 rounded cursor-pointer"
                        >
                          Rate Performance
                        </button>
                      </td>
