...
export default function EnhancedDashboard() {
  ...
  const chartData = [
    ...
    { name: "Others", value: stats.totalDisputes - stats.totalRatings },
  ];
  ...
  return (
    <Box
      ...
      // className=" bg-gradient-to-r from-white-400 to-teal-200"
    >
      {/* Top Row: Stats Cards */}
      <Grid container spacing={2}>
        {/* Total Employees */}
        <Grid item xs={12} md={4}>
          <Card
            sx={{
              borderRadius: 3,
              boxShadow: "0 4px 10px rgba(0,0,0,0.15)",
              // backgroundColor: " #E0F7F3", // Faded blue background
            }}
            // className=" bg-gradient-to-r from-teal-100 to-teal-200"
          >
            <CardContent>
              <Box display="flex" alignItems="center" mb={1}>
        ...
        <Grid item xs={12} md={4}>
          <Card
            sx={{
              borderRadius: 3,
              boxShadow: "0 4px 10px rgba(0,0,0,0.15)",
              // backgroundColor: "#E0F7F3", // Faded red background
            }}
        ...
        <Grid item xs={12} md={4}>
          <Card
            sx={{
              borderRadius: 3,
              boxShadow: "0 4px 10px rgba(0,0,0,0.15)",
              // backgroundColor: " #E0F7F3", // Faded yellow background
            }}
            // className=" bg-gradient-to-r from-teal-400 to-blue-400"
          >
            <CardContent>
              <Box display="flex" alignItems="center" mb={1}>
                <CheckCircleIcon sx={{ color: "warning.main", fontSize: 40, mr: 2 }} />
                <Typography variant="h6" fontWeight="bold">
                  Total Blacklist
                </Typography>
              </Box>
      ...
      {/* Middle Row: Employee Records & Disputation Breakdown */}
      <Grid container spacing={2} mt={2}>
        {/* Employee Records Table */}
        <Grid item xs={12} md={8} >
          <Card sx={{ borderRadius: 3, boxShadow: "0 4px 10px rgba(0,0,0,0.15)" }}>
            <CardContent >
...
>
                      ...
                      <TableRow key={index}>
                        ...
                        <TableCell>
                          <Box sx={statusStyles[record.dateOfJoin]}>
                            {new Date(record.dateOfJoin).toLocaleDateString("en-US", {
                              month: "2-digit",
                              day: "2-digit",
                              year: "2-digit",
                            })}
        ...
        <Grid item xs={12} md={4}>
          <Card
            ...
            // className=" bg-gradient-to-r from-teal-400 to-blue-300"
          >
            <CardContent>
              <Typography variant="h6" fontWeight="bold" gutterBottom>
                Disputation Breakdown
