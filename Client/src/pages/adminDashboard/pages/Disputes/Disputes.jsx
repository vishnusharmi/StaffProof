    ...
    <div className="p-3 ">
        ...
        <div className="flex space-x-3">
          ...
          <div className="relative w-52">
            <button
              ...
              className="w-full px-4 py-3 text-white bg-teal-500 hover:bg-teal-700 rounded-xl shadow-md flex justify-between items-center"
            >
              {selected}
              <svg
              ...
              >
                {options.map((option) => (
                  <li
                    ...
                    className="px-4 py-3 text-gray-700 hover:bg-teal-500 hover:text-white cursor-pointer"
                  >
                    {option}
                  </li>
                ))}
          ...
          <Button onClick={() => fetchDisputes()} variant="contained" className="bg-gradient-to-r from-teal-500 to-teal-500 hover:from-teal-700 hover:to-teal-700">
            <AutorenewIcon />
          </Button>
        </div>
        ...
        <Fade in={open}>
          <Box sx={style}>
            ...
            <div className="mt-4 flex justify-end">
              ...
              className = " bg-gradient-to-r from-teal-500 to-teal-500 hover:from-teal-700 hover:to-teal-700">
      ...
      <Paper>
        <TableContainer component={Paper} className="shadow-xl overflow-y-auto h-[270px]">
          <Table>
            <TableHead className=" bg-gradient-to-r from-teal-500 to-teal-500">
              <TableRow>
