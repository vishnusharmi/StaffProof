  ...
  return (
            ...
            <div className="p-6 space-y-2">
              <div>
                ...
                <input
                  ...
                  className="block w-full rounded-md border-gray-300 shadow-sm focus:border-teal-500 focus:ring-teal-500 p-1 border"
                />
              </div>
              <div>
                <label
              ...
              <div className="pt-4 flex justify-between">
                <button
                  type="button"
                  onClick={handleCancel}
                  className="cursor-pointer inline-flex justify-center py-2 px-4 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500"
                >
                  Cancel
                </button>
    ...
    ${
      isNextDisabled()
        ...
        : "bg-teal-500 hover:bg-teal-700 text-white cursor-pointer"
    }`}
                >
                  Next
                </button>
            ...
            <div className="p-6 space-y-2 overflow-y-scroll max-h-100">
              ...
              <div className="flex justify-start mt-2">
                <button
                  ...
                  className="inline-flex items-center text-sm text-teal-500 hover:text-teal-700"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
