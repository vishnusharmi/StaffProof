    ...
    <div className="min-h-screen bg-gray-100 p-3 md:p-4 md:pt-2 overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-3">
        ...
        <div className="flex flex-wrap gap-2 md:gap-3">
          <button
            ...
            className="bg-teal-500 text-white px-3 md:px-4 py-2 rounded-lg hover:bg-teal-700 flex items-center gap-2"
          >
      ...
      <div className="border border-gray-200 rounded-lg shadow-md bg-white overflow-hidden">
        <table className="min-w-full border-collapse rounded-lg overflow-hidden">
          {/* Table Header */}
          <thead className="bg-gradient-to-r from-teal-500 to-teal-600 text-white rounded-t-lg">
