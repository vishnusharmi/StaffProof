          ...
          <div className="relative bg-white rounded-lg w-full max-w-lg p-4 shadow-lg border border-gray-300 z-10">
            ...
            <div className="mb-6">
              ...
              <div className="flex justify-between text-sm text-gray-600">
                <span className={step === 1 ? "text-teal-600 font-medium" : ""}>Personal Info</span>
                <span className={step === 2 ? "text-teal-600 font-medium" : ""}>Employment Details</span>
                <span className={step === 3 ? "text-teal-600 font-medium" : ""}>Documents & Banking</span>
              </div>
            </div>
            ...
            {step === 1 && (
              <div className="max-h-[65vh] overflow-y-auto">
                ...
                <div className="flex justify-between mt-4">
                  ...
                  <button
                    onClick={() => setStep(2)}
                    className="px-6 py-2 bg-teal-500 text-white font-semibold rounded-lg hover:bg-teal-700 transition-colors cursor-pointer"
                  >
                    Next
                  </button>
                </div>
              ...
              <div className='max-h-[65vh] overflow-y-auto'>
                ...
                <div className="flex justify-between mt-8">
                  ...
                  <div>
                    ...
                    <button
                      className="px-6 py-3 bg-teal-500 font-semibold text-white rounded-lg hover:bg-teal-700 transition-colors cursor-pointer"
                      onClick={() => setStep(3)}
                    >
                      Next
                    </button>
