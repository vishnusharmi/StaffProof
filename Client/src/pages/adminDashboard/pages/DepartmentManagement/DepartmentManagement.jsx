            ...
            <div className="p-4 bg-white rounded-lg">
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <button
                        ...
                        className="cursor-pointer flex items-center px-4 py-2 bg-teal-500 text-white rounded-lg hover:bg-teal-700"
                ...
                <thead className="bg-gradient-to-r from-teal-500 to-teal-500">   <tr>
