    ...
    <>
      <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4">
        <div className="w-full max-w-md p-8 bg-white rounded-2xl shadow-xl">
          ...
          <div className="flex justify-between px-2 mt-4 text-teal-600">
            <span className="flex items-center gap-1">
              <AccessTimeIcon fontSize="small" className="text-teal-500" />
              {timeLeft}s
            </span>
            <button
              onClick={resendOTP}
          ...
          <button
            ...
            className="w-full py-3 mt-6 rounded-lg text-white text-lg bg-teal-500 hover:bg-teal-700"
          >
